 ...
 *
 */
public class XltCharBuffer implements CharSequence
{
    ...
    {
        final List<XltCharBuffer> result = new SimpleArrayList<>();
    ...
    /**
     * The hashcode. Don't cache, because it might change, because we permit PUT
     * This makes this buffer not suitable for hashmaps as keys for instance, because
     * the content can change. If you are sure, you don't change the content, feel
     * free!
     * 
